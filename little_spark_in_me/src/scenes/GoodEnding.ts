...
export class GoodEnding extends Scene
{
    ...
    create ()
    {
        ...
        textFade(this.msg_text_1, 100, 'You managed to save all the children', 0, this)
        textFade(this.msg_text_2, 180, 'It\'s good that you didn\'t give up', 2000, this)
        textFade(this.msg_text_2, 260, 'Your heart is in the right place', 4000, this)
