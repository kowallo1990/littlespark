...
export class Lvl10 extends LvlPrototype
{
    text: any; 
    ...
    create ()
    {
        this.text = this.add.text(this.makeScale(100), this.makeScale(100), 'Level 10', { fontSize: '32px', color: '#fff' });
        this.text.depth = 101
        ...
        this.platforms.create(window.innerWidth/2-this.makeScale(400), window.innerHeight-this.makeScale(50), 'obsticle').setScale(this.makeScale(1)).refreshBody();
        this.platforms.create(window.innerWidth/2+this.makeScale(400), window.innerHeight-this.makeScale(50), 'obsticle').setScale(this.makeScale(1)).refreshBody();
        ...
        this.createEnemyBoundaries(this.enemy, this.enemyBlocksLeft, this.enemyBlocksRight, window.innerWidth/2-this.makeScale(390), window.innerHeight-this.makeScale(50), window.innerWidth/2+this.makeScale(390), window.innerHeight-this.makeScale(50))
    }
